...
//        All rights reserved
//
//        filename :Rapezoid.cs
//        description :
//
//        created by 张恭亮 at  2020/10/21 17:03:52
//
//======================================================================
...
{
	[ToolShape(DisPlayText = "梯形")]
	public class Rapezoid : ShapeBase
	{
		#region Proterties
		...
		[Browsable(false)]
		public override string ShapeName => "Rapezoid";

		#endregion

		#region Constructor

		public Rapezoid() : base()
		{
			rectangle.Width = 100;
			rectangle.Height = 33;
		}
		...
		/// </summary>
		/// <param name="s"></param>
		public Rapezoid(DiagramControl s) : base(s)
		{
		}
		#endregion
		...
		public override void Paint(System.Drawing.Graphics g)
		{
			...
			points.Add(new PointF(rectangle.X + point.X + this.Width - (int)(_offset * Scale), rectangle.Y + point.Y));
			points.Add(new PointF(rectangle.X + point.X + this.Width, rectangle.Y + point.Y + this.Height));
